...
export const EntriesMenu = () => {
  ...
  <div>
    ...
    <Link to='/profile/settings'>
      <a  className="text-gray-700 block px-4 py-2 text-sm " role="menuitem"  id="menu-item-0">Профиль</a>    
      </Link>
    </div>  
   
    <div className="py-1" role="none">

      <a onClick={signOut} className="text-gray-700 block px-4 py-2 text-sm hover:bg-slate-100" role="menuitem"  id="menu-item-6">Выйти</a>
    </div>
  </div>
    </>
    : sellerIsActive ?
    ...
    <div className="py-1 hover:bg-slate-100" role="none">
      ...
      <button  className="text-gray-700 block px-4 py-2 text-sm " role="menuitem"  id="menu-item-0">Профиль продавца</button>    
            </Link>
    </div>  
