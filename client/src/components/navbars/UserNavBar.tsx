...
{sellerIsActive ? 
      ...
      <p className="text-2xl font-bold text-blue-800 ml-4"></p>
        ...
        {/* <div className='ml-10 w-6/12 flex'>
         <SearchBar/>
        </div> */}
        {userIsActive ? 
        <>
      ...
      <button onClick={setModalActiveRegseller} className='mr-5 ml-2 px-1 h-9 w-2/12 text-sm py-1 rounded-lg border-2 border-gray-300  hover:bg-[#0d7490]/80 hover:text-white'>Регистрация продавца</button>
      </> 
        :
        ...
        <NewEntriesMenu/>
                    ...
                    <div className="flex cursor-pointer items-center gap-x-1 rounded-md py-2 px-4 hover:bg-[#0d7490]/10">
       ...
       <Link to='/profile/favourites' className='w-1/12'>
                       <div className="flex cursor-pointer justify-center items-center gap-x-1 rounded-md py-2 px-4 hover:bg-[#0d7490]/10">
       ...
       sellerIsActive ?
       <>
        <div className='ml-10 w-7/12 flex'>
         <SearchBar/>
        </div>
       ...
       <Link to='/profileSeller/orders' className='w-1/12'>
                    ...
                    <div className="mr-5 flex cursor-pointer items-center gap-x-1 rounded-md py-2 px-4 hover:bg-[#0d7490]/10">
                      <div className="relative">
       ...
       <>
        ...
        <button onClick={setModalActiveLogSeller} className='mr-2 px-1 h-9 py-1 text-sm font-medium rounded-lg border-2 border-gray-300  hover:bg-[#0d7490]/80 hover:text-white'>Войти как продавец</button>
        <button onClick={setModalActiveRegseller} className='ml-2 px-1 h-9  text-sm py-1 font-medium rounded-lg border-2 border-gray-300  hover:bg-[#0d7490]/80 hover:text-white'>Регистрация продавца</button>
       ...
       <>
         ...
         <div className='w-4/12 flex justify-center'>
        <button onClick={setModalActiveLog} className='mr-3 px-4 py-1 rounded-lg font-medium border-2 border-gray-300  hover:bg-[#0d7490]/80 hover:text-white'>Войти</button>
        <button onClick={setModalActiveReg} className=' ml-3 px-4 py-1 rounded-lg font-medium border-2 border-gray-300  hover:bg-[#0d7490]/80 hover:text-white'>Регистрация</button>
