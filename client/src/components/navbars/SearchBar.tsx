...
export const SearchBar = () => {
  ...
  return (
    <>
     <input type='search' onChange={changeSearchHandler} value={searchWord} name='search' className='w-11/12 py-1.5 border-2 border-gray-500 rounded-lg text-center'></input>
