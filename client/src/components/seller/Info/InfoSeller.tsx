...
<div className="bg-gray-100 m-8">
        <div className="flex-col 2xl:flex-row space-y-4 4xl:space-y-0">
          ...
          <div className="w-full flex 2xl:w-full justify-between bg-white rounded-lg shadow-xl items-center">
          ...
          <div className="w-full flex 2xl:w-full justify-between rounded-lg shadow-xl items-center bg-white">
            <div className="w-2/3 flex-col p-8">
