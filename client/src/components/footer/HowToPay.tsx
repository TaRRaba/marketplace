...
export const HowToPay = () => {
  return (
    <div>
      <h1 className='text-center font-bold text-2xl mb-2'>Способы оплаты</h1>
      ...
      <div className=' mb-1'>Покупая на LocalMarket, вы можете выбрать любой из доступных способов оплаты:</div>
      <div className=' mb-2'>Оплачивайте заказы банковской картой.</div>
      ...
      <h3 className=' mb-2 text-lg font-semibold'>После оплаты заказа вы получите электронный чек.</h3>
      </div>
      </div>
    </div>
  )
