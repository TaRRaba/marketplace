  ...
  return (
    <form id="payment-form" onSubmit={handleSubmit}>
      ...
      <button className="w-full" disabled={isProcessing || !stripe || !elements} id="submit">
        <div id="button-text">
          {isProcessing ? <p className="mt-4">Платеж в обработке...</p> : <button id="orderBtn" data-userid='{user.id}' type="button" className="mt-6 w-full rounded-md py-1.5 font-medium text-blue-50 bg-[#0d7490] hover:bg-[#0d7490]/80">Оплатить заказ</button>}
        </div>
      </button>
